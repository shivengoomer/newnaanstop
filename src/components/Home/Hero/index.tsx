        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
          <div className="col-span-6">
            ...
            <p className="text-black/55 dark:text-white/50 lg:text-lg font-normal mb-10 lg:text-start text-center">
              Your all-in-one recipe hub, from quick bites to gourmet
              delights.🍴
            </p>
            <div className="flex flex-col md:flex-row items-center justify-center lg:justify-start">
              <Link
                href="#cook-section"
                className="text-xl w-full md:w-auto font-medium rounded-full text-white py-5 px-6 bg-primary hover:text-primary lg:px-14 md:mr-6 border border-primary hover:bg-transparent text-center"
              >
                Lets cook
              </Link>
              <Link
          ...
          <div className="col-span-6 flex justify-center relative">
            <div className="flex bg-white p-2 gap-5 items-center bottom-10 left-10 rounded-xl absolute">
              ...
              <p className="text-lg font-normal">
                All the delicious and popular recipes <br /> recipes.
              </p>
            </div>
            <Image
